      ...
      <div className="w-full max-w-md glass p-8 rounded-2xl shadow-xl border border-border z-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full py-2.5 bg-primary text-primary-foreground rounded-lg font-medium hover:opacity-90 transition-opacity flex justify-center disabled:opacity-50"
          >
